...
// ── Store globale: apri/chiudi da qualsiasi componente ──
...
export default function SearchOverlay() {
  ...
  // Focus automatico all'apertura, reset alla chiusura
  useEffect(() => {
    if (isOpen) {
                ...
                <div style={{ flex: 1, position: 'relative' }}>
                  ...
                  <input
                    ...
                    style={{
                      ...
                      border: '1.5px solid rgba(187,0,255,0.3)',
                      color: 'var(--text)',
                      fontSize: 14,
                      outline: 'none',
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <p style={{ color: 'var(--meta-color)', fontSize: 10, marginTop: 2 }}>
                            {cat.emoji} {cat.label} · {place.location?.neighborhood}
                          </p>
                        </div>
