...
exports.default = PlaceCardSkeleton;
function PlaceCardSkeleton(_a) {
    var _b = _a.variant, variant = _b === void 0 ? 'default' : _b;
    if (variant === 'hero') {
        return (<div className="rounded-[22px] overflow-hidden skeleton" style={{ aspectRatio: '3/4' }}/>);
    }
    return (<div className="rounded-[20px] overflow-hidden border border-[var(--border)]" style={{ background: 'var(--surface)' }}>
